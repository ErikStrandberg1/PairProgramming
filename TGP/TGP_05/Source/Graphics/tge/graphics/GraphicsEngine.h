...
{ 
	...
	public:
		...
		FullscreenEffect& GetFullscreenBloom() const { return *myFullscreenBloom; };

		FullscreenEffect& GetFullscreenEffectDownsample() const { return *myFullscreenDownsample; };
		FullscreenEffect& GetFullscreenEffectUpsampleAndScaleBloom() const { return *myFullscreenUpsampleAndScaleBloom; };
	...
	private:
		...
		std::unique_ptr<FullscreenEffect> myFullscreenBloom;

		std::unique_ptr<FullscreenEffect> myFullscreenDownsample;
		std::unique_ptr<FullscreenEffect> myFullscreenUpsampleAndScaleBloom;
