...
bool GraphicsEngine::Init()
{
	...
	myFullscreenUpsampleAndScaleBloom = std::make_unique<FullscreenEffect>();
	if (!myFullscreenUpsampleAndScaleBloom->Init("Shaders/PostProcessUpSamplePS"))
		return false;
	myFullscreenDownsample = std::make_unique<FullscreenEffect>();
	if (!myFullscreenDownsample->Init("Shaders/PostProcessDownSamplePS"))
		return false;
